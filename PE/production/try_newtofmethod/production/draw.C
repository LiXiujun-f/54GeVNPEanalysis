...
TCanvas* c = new TCanvas("c","c");
  ...
  TH2F* hsige = (TH2F*)f->Get("hnSigE_e_Dz");
  TH2F* hsigels = (TH2F*)f->Get("hnSigE_e_ls_Dz");
  hsige->Add(hsigels,-2);
  hsige->Draw("colz");

  gPad->SetLogz(1); 
  addpdf(pdf);
  TH1F* hsigeY = (TH1F*)hsige->ProjectionY("ul");
  hsigeY->Draw();
  addpdf(pdf);
  // return;
  // hsigeY->Rebin(8);
  ...
  addpdf(pdf);
  gPad->SetLogy(1);
  TH1F* hincE = (TH1F*)hincEptCent->ProjectionX();
  hincE->Draw();
  addpdf(pdf);
  ...
  TH2F* hnSigE_k_sb = (TH2F*)f->Get("hnSigE_k_wd");
  hnSigE_k_sb->Draw("colz");
  addpdf(pdf);

  TH2F* hnSigE_k_wd = (TH2F*)f->Get("hnSigE_k_tof");
  hnSigE_k_wd->Add(hnSigE_k_sb,-0.2);
  hnSigE_k_wd->Draw("colz");
  addpdf(pdf);
  ...
  TH2F* hnSigE_p_sb = (TH2F*)f->Get("hnSigE_p_wd");
  hnSigE_p_sb->Draw("colz");
  addpdf(pdf);

  TH2F* hnSigE_p_wd = (TH2F*)f->Get("hnSigE_p_tof");
  hnSigE_p_wd->Add(hnSigE_p_sb,-0.2);
  hnSigE_p_wd->Draw("colz");
  addpdf(pdf);
