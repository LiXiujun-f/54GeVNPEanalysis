void myexp(Double_t *x, Double_t *par){
  // if ((x[0]<1.55&&x[0]>1) || (x[0]<0.6&&x[0]>0.5)){
  if (  (x[0]<0.55&&x[0]>0.5)){
    TF1::RejectPoint();
  }
...
void constrainfit(){
  ...
  TF1* fit = new TF1("fit",myexp,2,3,2); 
  hey->Draw();
...
//   hey->Draw();
//   hey->GetXaxis()->SetRangeUser(0.5,2);
//   gPad->SetLogy();
//   hey->Fit(fit);
//
// } 
...
//   TF1* fit = new TF1("fit",myexp,0.8,1.6,2); 
//   hey->Draw();
//   hey->GetXaxis()->SetRangeUser(0.8,1.6);
//   gPad->SetLogy();
//   hey->Fit(fit);
// } 
//
...
//   TF1* fit = new TF1("fit",myexp,1,2,2); 
//   hey->Draw();
//   hey->GetXaxis()->SetRangeUser(1,2);
//   gPad->SetLogy();
//   hey->Fit(fit);
// } 
