...
void writepurity()
{
 ...
 TGraph* gptsys=(TGraph*)turnhist2graph(hpsys ,gP_Pt ,"gptsys");
 cout <<"start" << endl;
 TGraph* gptdef=(TGraph*)turnhist2graph(hpdef ,gP_Pt ,"gptdef");
 cout <<"start" << endl;
 ...
 {
    gptparsys[ip]=(TGraph*)turnhist2graph(hpar_sys[ip],gP_Pt,Form("g%s_sys",name[ip]));
 cout <<"start" << endl;
    gptpardef[ip]=(TGraph*)turnhist2graph(hpar[ip],gP_Pt,Form("g%s",name[ip])); 
 cout <<"start" << endl;
 }
