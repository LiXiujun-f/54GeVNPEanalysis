...
void calHadronv2()
{
  ...
  pHadv2->GetXaxis()->SetTitle("p_{T} (GeV)");;
  pHadv2->GetYaxis()->SetTitle("v2{#eta gap}");;
  pHadv2->Draw("psame");
 ...
 l->AddEntry(pHadv2,"Hadron v_{2} 30-40%","pl"); 
 l->AddEntry(g1,"STAR 39GeV","pl"); 
 l->AddEntry(g3,"STAR 27GeV","pl"); 
 l->AddEntry(g2,"PHENIX 62GeV","pl"); 
 l->Draw();
}
