...
void HFev2_sys()
{
  ...
  // hmgpi->SetDirectory(0);
   TGraph* hpurity = (TGraph*)fpurity->Get("gpurity_ptsys"); 
   TGraph* hp = (TGraph*)fpurity->Get("gpratio_ptsys"); 
   TGraph* hpi = (TGraph*)fpurity->Get("gkratio_ptsys"); 
   TGraph* hk = (TGraph*)fpurity->Get("gpiratio_ptsys"); 
   TGraph* hmgpi = (TGraph*)fpurity->Get("gmgpiratio_ptsys"); 
