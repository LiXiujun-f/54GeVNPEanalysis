...
void compareRecoEv2()
{
  ...
  TH1F*  hRecoEv2_2_8 = (TH1F*)file->Get("hRecoEv2_6_8");
  TH1F*  hPhoEv2_2_8= (TH1F*)file->Get("hPhoEv2_6_8");
  TF1* fRecoE_2_8 = (TF1*)file->Get("fRecoE_6_8");
  ...
  hRecoEv2_2_8->GetFunction("fRecoE_6_8")->Delete();
  hRecoEv2_2_8->Scale(scalefactor);

  hPhoEv2_2_8->GetFunction("fPhoE_6_8")->Delete();
