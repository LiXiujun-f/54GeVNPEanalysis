...
void HFev2()
{
  ...
  TFile* fpurity = TFile::Open("Nsigma_6_8_purity.root");
  ...
  TFile* freco = TFile::Open("fitRecoEff_6_8.root");
  ...
  TF1* fitPhev2 = (TF1*)fPhev2->Get(Form("fPhoE_%d_%d",centL-1,centH-1));
  TH1F* hphev2Mc = (TH1F*)fPhev2->Get(Form("hPhoEv2_%d_%d",centL-1,centH-1));
