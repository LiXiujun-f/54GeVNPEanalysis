...
void runMinitreeMaker(TString filelist="try.list",  TString outFileName="test")
{
  ...
  miniTreeMaker->setRecenterFile("StRoot/StMiniTreeAnalysis/eventplane/recenter_vz40.root");
  miniTreeMaker->setShiftFile("StRoot/StMiniTreeAnalysis/eventplane/shift_vz40.root");
  // -------------- USER variables -------------------------
  miniTreeMaker->Init();
  miniTreeMaker->Make();
