...
void generateRecaleHists(TString inputfilename="data/test_pi0_1011.root", TString outputname="rescaleFile/test_pi0_DzGm.root",double branchratio=0.988*2)
{
  ...
  // int scaleEvents = 3e8;
  double scalefactor = 0.95*scaleEvents*branchratio*ptrange*etarange/totalnPi0;  
  ...
  readScaleAndWrite<TH1F>("hEvent",scaleEvents/totalnPi0,fin,fout);
